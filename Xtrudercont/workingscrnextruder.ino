...
//Adafruit_ST7735  tft = Adafruit_ST7735(TFT_CS, TFT_DC, TFT_RST); // second use
...
boolean needRefresh = false;//true; //
long oldPosition = 0;
int selection = 0;
int optionCount = 5;
...
void showMotorControlScreen()
{
  ...
  tft.println(motorActive ? "INACTIVE" : "ACTIVE");
}
